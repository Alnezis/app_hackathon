...
class _DrivingExampleState extends State<_DrivingExample> {
  ...
  final Placemark startPlacemark = Placemark(
    ...
    icon: PlacemarkIcon.single(
        PlacemarkIconStyle(
            image: BitmapDescriptor.fromAssetImage('assets/map/route_start.png'),
            scale: 0.3
        )
    ),
  );
  final Placemark stopByPlacemark = Placemark(
    ...
    icon: PlacemarkIcon.single(
        PlacemarkIconStyle(
            image: BitmapDescriptor.fromAssetImage('assets/map/route_stop_by.png'),
            scale: 0.3
        )
    ),
  );
  final Placemark endPlacemark = Placemark(
      ...
      icon: PlacemarkIcon.single(
          PlacemarkIconStyle(
              image: BitmapDescriptor.fromAssetImage('assets/map/route_end.png'),
              scale: 0.3
          )
      )
  );
